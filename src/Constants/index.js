...
export const experiences = [
    ...
    },
    {
        ...
        company_name: "Sindri Systems LLP",
        icon: sindri,
        iconBg: "#a2d2ff",
        date: "Sept 2024 - Present",
        points: [
            "Collaborated effectively with backend developers to integrate RESTful APIs, ensuring 100% data consistency and smooth communication between frontend and backend systems.",
            "Implemented responsive design strategies, achieving cross-device compatibility and enhancing mobile user experience, contributing to a 25% increase in mobile traffic.",
            "Actively participated in code reviews, helping to reduce bugs by 40% and improve overall code quality by adhering to industry best practices and clean code standards.",
        ],
    },
];
